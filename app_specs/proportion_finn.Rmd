...
ui <- pageWithSidebar(
  ...
  sidebarPanel = sidebarPanel(
    ...
    numericInput("sample size", "Sample Size"),
    sliderInput("level", "Level", min=0, max=100, value=90),
    selectInput("input_level", "Input Level", choices=DescTools::BinomCI()),
  ...
  mainPanel = mainPanel(
    cloumn(
    plotOutput("plot"),
    textOutput("The total Number of Intervals so far is: ,\n
               x Intervals contain the proportion, and \n
               The percentage of intervals containing the proportion is: .")
  )
  )
)
