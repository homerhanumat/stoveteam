...
When we keep all of the measurments, we find that:
...
We have run some simulation studies to get some idea of the effect of the likely skewness of the population and the non-uniformity of the sample size from household to household on the performance of confidence intervals.  In our simulations the parametric 90%-confidence intervals constrcuted using all of the data actually cover the mean about 89% of the time.  It may be acceptable to use this interval formula and to keep all of the data.
