...
From Section 12(a) of the document *CDM-EB50-A30-STAN*:
...
The document *CDM-EB50-A30-STAN* specifies that confidence interval for a mean have a precision of no more than 10%.  In Section 12(b) of the doicument, precision for a confidence interval for the mean is defined as the margin of error divided by the sampl mean (multipled by 100 to convert to a percentage).
