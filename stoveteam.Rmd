...
has a distribution that approaches the standard normal distribution (mean 0, vaiance 1) as the sample size $n$ increases.  Therefore, for a "large-enough" sample of households, we may take the normal-based confidence interval
...
However, the actual coverage-properties of these confidence intervals can be significantly different from their advertised confidence levels when the sample size is small, and especially when the the sample size is small and the population distribution is skewed.
